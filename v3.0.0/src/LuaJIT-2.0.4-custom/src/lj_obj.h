...
#define MMDEF(_) \
  ...
  /* Bit Operations and Integer Division by yoya. */ \
  _(band) _(bor) _(bxor) _(bshl) _(bshr) _(idiv) _(unm) \
...
/* SeleneTalk/Lua switch flag by yoya. */
LJ_DATA int8_t lj_obj_sltkmode;
