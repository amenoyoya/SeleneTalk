...
#define BCDEF(_) \
  ...
  _(BAND,	dst,	var,	var,	band) /* added by yoya. */ \
  _(BOR,	dst,	var,	var,	bor)  /* added by yoya. */ \
  _(BXOR,	dst,	var,	var,	bxor) /* added by yoya. */ \
  _(BSHL,	dst,	var,	var,	bshl) /* added by yoya. */ \
  _(BSHR,	dst,	var,	var,	bshr) /* added by yoya. */ \
  _(IDIV,	dst,	var,	var,	idiv) /* added by yoya. */ \
  \
  /* Constant ops. */ \
