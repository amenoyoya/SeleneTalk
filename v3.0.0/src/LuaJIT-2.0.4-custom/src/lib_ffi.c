...
LJLIB_CF(ffi_meta___band)	LJLIB_REC(cdata_arith MM_band) /* added by yoya. */
{
  return ffi_arith(L);
}

LJLIB_CF(ffi_meta___bor)	LJLIB_REC(cdata_arith MM_bor) /* added by yoya. */
{
  return ffi_arith(L);
}

LJLIB_CF(ffi_meta___bxor)	LJLIB_REC(cdata_arith MM_bxor) /* added by yoya. */
{
  return ffi_arith(L);
}

LJLIB_CF(ffi_meta___bshl)	LJLIB_REC(cdata_arith MM_bshl) /* added by yoya. */
{
  return ffi_arith(L);
}

LJLIB_CF(ffi_meta___bshr)	LJLIB_REC(cdata_arith MM_bshr) /* added by yoya. */
{
  return ffi_arith(L);
}

LJLIB_CF(ffi_meta___idiv)	LJLIB_REC(cdata_arith MM_idiv) /* added by yoya. */
{
  return ffi_arith(L);
}
