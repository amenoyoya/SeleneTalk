...
** Generated automatically by tolua++-1.0.93 on 09/24/17 14:57:12.
*/
...
static int tolua_libSLTK_win32_Sltk_Win32_Variant_new00(lua_State* tolua_S)
{
...
#endif
 {
  ...
  const char* str = ((const char*)  tolua_tostring(tolua_S,3,""));
...
/* method: click of class  Sltk::Win32::HTMLElement */
#ifndef TOLUA_DISABLE_tolua_libSLTK_win32_Sltk_Win32_HTMLElement_click00
static int tolua_libSLTK_win32_Sltk_Win32_HTMLElement_click00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
  {
   bool tolua_ret = (bool)  self->click();
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
...
/* method: getTag of class  Sltk::Win32::HTMLElement */
#ifndef TOLUA_DISABLE_tolua_libSLTK_win32_Sltk_Win32_HTMLElement_getTag00
static int tolua_libSLTK_win32_Sltk_Win32_HTMLElement_getTag00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
  {
   string tolua_ret = (string)  self->getTag();
   tolua_pushcppstring(tolua_S,(const char*)tolua_ret);
  }
 }
 return 1;
...
/* method: operator[] of class  Sltk::Win32::HTMLElementCollection */
#ifndef TOLUA_DISABLE_tolua_libSLTK_win32_Sltk_Win32_HTMLElementCollection__geti00
static int tolua_libSLTK_win32_Sltk_Win32_HTMLElementCollection__geti00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
  {
   Sltk::Win32::HTMLElement tolua_ret = (Sltk::Win32::HTMLElement)  self->operator[](index);
   {
#ifdef __cplusplus
...
/* method: getElementsByTag of class  Sltk::Win32::Browser */
#ifndef TOLUA_DISABLE_tolua_libSLTK_win32_Sltk_Win32_Browser_getElementsByTag00
static int tolua_libSLTK_win32_Sltk_Win32_Browser_getElementsByTag00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getElementsByTag'", NULL);
#endif
  {
   Sltk::Win32::HTMLElementCollection tolua_ret = (Sltk::Win32::HTMLElementCollection)  self->getElementsByTag(tagName);
   {
#ifdef __cplusplus
    void* tolua_obj = Mtolua_new((Sltk::Win32::HTMLElementCollection)(tolua_ret));
     tolua_pushusertype(tolua_S,tolua_obj,"Sltk::Win32::HTMLElementCollection");
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getElementsByTag'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: getElementsByName of class  Sltk::Win32::Browser */
#ifndef TOLUA_DISABLE_tolua_libSLTK_win32_Sltk_Win32_Browser_getElementsByName00
static int tolua_libSLTK_win32_Sltk_Win32_Browser_getElementsByName00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  const char* name = ((const char*)  tolua_tostring(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getElementsByName'", NULL);
#endif
  {
   Sltk::Win32::HTMLElementCollection tolua_ret = (Sltk::Win32::HTMLElementCollection)  self->getElementsByName(name);
   {
#ifdef __cplusplus
    void* tolua_obj = Mtolua_new((Sltk::Win32::HTMLElementCollection)(tolua_ret));
     tolua_pushusertype(tolua_S,tolua_obj,"Sltk::Win32::HTMLElementCollection");
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getElementsByName'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: executeCommand of class  Sltk::Win32::Browser */
#ifndef TOLUA_DISABLE_tolua_libSLTK_win32_Sltk_Win32_Browser_executeCommand00
static int tolua_libSLTK_win32_Sltk_Win32_Browser_executeCommand00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  bool showUI = ((bool)  tolua_toboolean(tolua_S,3,false));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'executeCommand'", NULL);
#endif
  {
   bool tolua_ret = (bool)  self->executeCommand(command,showUI);
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
...
/* method: executeCommand of class  Sltk::Win32::Browser */
#ifndef TOLUA_DISABLE_tolua_libSLTK_win32_Sltk_Win32_Browser_executeCommand01
static int tolua_libSLTK_win32_Sltk_Win32_Browser_executeCommand01(lua_State* tolua_S)
{
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"Sltk::Win32::Browser",0,&tolua_err) ||
     ...
     (tolua_isvaluenil(tolua_S,4,&tolua_err) || !tolua_isusertype(tolua_S,4,"const Sltk::Win32::Variant",0,&tolua_err)) ||
     !tolua_isnoobj(tolua_S,5,&tolua_err)
 )
  goto tolua_lerror;
 else
 {
  Sltk::Win32::Browser* self = (Sltk::Win32::Browser*)  tolua_tousertype(tolua_S,1,0);
  const char* command = ((const char*)  tolua_tostring(tolua_S,2,0));
  bool showUI = ((bool)  tolua_toboolean(tolua_S,3,0));
  const Sltk::Win32::Variant* value = ((const Sltk::Win32::Variant*)  tolua_tousertype(tolua_S,4,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'executeCommand'", NULL);
#endif
  {
   bool tolua_ret = (bool)  self->executeCommand(command,showUI,*value);
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
tolua_lerror:
 return tolua_libSLTK_win32_Sltk_Win32_Browser_executeCommand00(tolua_S);
}
#endif //#ifndef TOLUA_DISABLE
  ...
  tolua_beginmodule(tolua_S,"Sltk");
   ...
   tolua_beginmodule(tolua_S,"Win32");
    ...
    tolua_beginmodule(tolua_S,"HTMLElement");
     ...
     tolua_function(tolua_S,"click",tolua_libSLTK_win32_Sltk_Win32_HTMLElement_click00);
     tolua_function(tolua_S,"getTag",tolua_libSLTK_win32_Sltk_Win32_HTMLElement_getTag00);
    ...
    tolua_beginmodule(tolua_S,"HTMLElementCollection");
     ...
     tolua_function(tolua_S,".geti",tolua_libSLTK_win32_Sltk_Win32_HTMLElementCollection__geti00);
    ...
    tolua_beginmodule(tolua_S,"Browser");
     ...
     tolua_function(tolua_S,"getElementsByTag",tolua_libSLTK_win32_Sltk_Win32_Browser_getElementsByTag00);
     tolua_function(tolua_S,"getElementsByName",tolua_libSLTK_win32_Sltk_Win32_Browser_getElementsByName00);
     ...
     tolua_function(tolua_S,"executeCommand",tolua_libSLTK_win32_Sltk_Win32_Browser_executeCommand00);
     tolua_function(tolua_S,"executeCommand",tolua_libSLTK_win32_Sltk_Win32_Browser_executeCommand01);
